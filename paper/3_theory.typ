...
More often than not, politicians (and managers) must make decisions under uncertainty in the stricter sense, for instance, assume a large infrastructure project can conceivably be built on-time and in-budget or delayed and over-budget (and all permutations in-between), the likelihood of any one of those end-states cannot be objectively known at time of decision in the same way one can objectively know the likelihood of, say, winning a coin-toss.

Under conditions of uncertainty, individuals choose among alternatives by evaluating the expected utility of every possible outcome, based upon the "personal probability" #pre_cite(<savage-1972>, prefix: none, supplement: [p. 30]) they assign each possible "state" #pre_cite(<savage-1972>, prefix: none, supplement: [p. 9])

Even assuming politicians do not solely rely on their personal judgement for determining the likelihood distribution of the end-states of the large infrastructure project, but seek out information derived from scientifically sound strategies of quantifying that likelihood distribution, reasonable individuals will disagree over the assumptions made in the pursuit of any such strategy.
...
#grid(
  ...
  [#figure(
      ...
      table(
        ...
        align: left,
        stroke: none,
        table.header([State], [Outcome], [Payoff]),
        table.hline(start: 0, stroke: 0.7pt),
        [1], [Delay and extra costs don't increase], [payoff],
        [2], [Delay and extra costs increase], [payoff],
      ),
    )
  ],
  [#figure(
