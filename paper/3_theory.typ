...
Prima facia, this behavior is incongruent with the basic, both empirical and normative, principles of classical economic theories of decision making #pre_cite(<marshall-2013>, prefix: "e.g.", supplement: none), in particular marginal thinking, i.e. individuals evaluate decision alternatives on the _change in utility_ resulting from that decision versus the additional cost incurred -- previous investment decisions should (empirically and normatively) therefore not affect future decisions.
...
Moreover, since politicians, like managers, investors, etc., often allocate funds for projects whose outcomes are not fully certain and foreseeable at time of investment, e.g. whether a large construction project will be completed, or whether pension payments to retirees will be high enough to provide them with an adequate standard of living in the future, it will be efficient in general to look towards the well-developed canon of economic theories of decision making for a baseline of decision making _under conditions of uncertainty_, which much of the existing research, both economic and psychological, also in some way references.

It should be noted, due to its apparent violation of expectations derived from basic, classical economic theories of decision making, escalation of commitment has been referred to as "irrational" economic behavior by some researchers of the phenomenon #pre_cite(<arkes-1985>, prefix: "e.g.", supplement: "p. 124")@astebro-2007[p. 254]@northcraft-1986[p. 349] (also @bragger-1998@bragger-2003), but the contemporary workhorse economic decision making paradigm under uncertainty, namely Subjective Expected Utility #pre_cite(<savage-1972>, prefix: "see", supplement: none)@edwards-1954, does allow for, and has been use to model escalation of commitment in different ways #pre_cite(<sleesman-2012>, prefix: "see", supplement: "for an overview").

Again others refer only specifically to sunk cost effects as irrational #cite(<garland-1991>, form: "normal", supplement: none)#cite(<schmidt-2002>, form: "normal", supplement: none)

To illustrate: A decision under uncertainty, in a broader sense, is any decision situation in which the outcome of that decision is not deterministic, i.e. there is a stochastically determined distribution of possible outcomes @edwards-1954.
Some economists then further differentiate uncertain from risky decisions, wherein for risky decisions that distribution is principle observable, i.e. the odds of the possible outcomes can be straightforwardly computed, e.g. a lottery, and for uncertain decisions that distribution is not objectively knowable, e.g. sports betting #pre_cite(<edwards-1954>, prefix: "see", supplement: none).
More often than not, politicians (and managers) must make decisions under uncertainty in the stricter sense, for instance, assume a large infrastructure project can conceivably be built on-time and in-budget or delayed and over-budget (and all permutations in-between), the likelihood of any one of those end-states cannot be objectively known in the same way one can objectively know the likelihood of winning a coin-toss.
Even assuming politicians do not solely rely on their personal, i.e. subjective, judgement for determining the likelihood distribution of the end-states of the large infrastructure project, but seek out information derived from scientifically sound strategies of quantifying that likelihood distribution, that information is entirely dependent on model assumptions, so also _subjective_, whereas, in a mathematical sense, the probability distribution of a coin-toss will always be 50% heads, 50% tails.
