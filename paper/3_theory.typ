...
Subjects who received negative feedback in the #cite(<staw-1976>, form: "prose", supplement: none) experiment violated this principle in the second stage by allocating their resources in a way that does not maximize their return, given their decision alternatives -- investing all the money in the better performing company division would have maximized their return on investment.
...
Moreover, since politicians, like managers, investors, etc., often allocate funds for projects whose outcomes are not fully certain and foreseeable at time of investment, e.g. whether a large construction project will be completed, or whether pension payments to retirees will be high enough to provide them with an adequate standard of living in the future, it will be efficient in general to look towards the well-developed canon of economic theories of decision making for a baseline of decision making under conditions of uncertainty.
To begin with, due to its violation of expectations derived from basic, classical economic theories of decision making, has been referred to as "irrational" by some researchers of the phenomenon

despite escalation of commitment running counter to classical economic expectations, or intuition, for that matter, viewed from the standpoint of contemporary economic theories of decision making under uncertainty, with Subjective Expected Utility #pre_cite(<savage-1972>, prefix: "see", supplement: none) the relevant workhorse microeconomic model, do not necessarily
