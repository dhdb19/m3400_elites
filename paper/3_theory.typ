...
Later in this section I will argue why escalation of commitment and sunk cost will not be used interchangeably in this paper. Staying the course in the face of negative outcomes conceivably conceptually extends to many kinds of decisions situations, e.g. interpersonal relationships #pre_cite(<rego-2016>, prefix: "see e.g.", supplement: none)@olivola-2018.
...
Legislators effectuate political outcomes by voting on laws, regulations and the budget.
...
Construed thusly, all legislative decisions could be understood to be investment decisions, following the simple definition given by #cite(<staw-1976>, form: "prose", supplement: none).
...
I have previously used megaprojects, pensions programs as examples of policies that do not follow the logic of investment the same way R&D investment does in a private company.
...
A politician from a conservative district may still not view the war on drugs as a sunk cost that isn't generating a return for society, perhaps because a hard on crime and drugs stance has been a successful electoral strategy in their district.
And, of course, if politicians are not assumed to be rational agents who only seek reelection, e.g. when they are assumed to only vote according to their personal moral convictions, personal attributes #pre_cite(<bailer-2021>, prefix: [class, gender, marginalization etc., see e.g.], supplement: none)@bo-2017@chattopadhyay-2004, or role they occupy #pre_cite(<searing-1991>, prefix: [see e.g.], supplement: none) there is no a priori expectation for them to be sensitive to return on investment framing at all.
It follows that, if, how and to what extent legislators may exhibit escalation of commitment, should be _contingent on how they perceive their decision environment_, whether they perceive themselves to be making an investment or not.
