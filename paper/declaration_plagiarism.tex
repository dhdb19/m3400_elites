...
{
\small
\newgeometry{a4paper, left=1.75cm, right=2.25cm, top=1.5cm, bottom=1.75cm, includehead, headheight=1.5cm, includefoot, footskip=1.17cm}
\setstretch{1.05}
\setlength{\parindent}{0cm}
\myhelvetica
...
%------------------------------------------------------
\newgeometry{a4paper, left=1.75cm, right=2.25cm, top=1.5cm, bottom=1.75cm, includehead, headheight=4cm, includefoot, footskip=1.17cm}
\thispagestyle{page2}
