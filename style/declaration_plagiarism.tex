\documentclass[a4paper,10pt,xcolor=dvipsnames]{article}
...
\usepackage{wrapfig}
\usepackage{enumitem}
\usepackage[a4paper, left=1.75cm, right=2.25cm, top=4.58cm, bottom=1.75cm, includehead, headheight=0cm, includefoot, footskip=1.17cm, headsep=0cm]{geometry}
\usepackage{fancyhdr}
...
\newfontfamily{\myhelvetica}{TeX Gyre Heros}[Ligatures=TeX]
%fontsettings---------------------------------------------------
...
%headerfooterplagraism---------------
\fancypagestyle{page1}{
\fancyhead{}
\fancyfoot{}
\fancyhf{}
% \fancyhead[R]{\hspace*{\fill}\includegraphics[scale=1]{Logo_correct.pdf}}
\fancyfoot[L]{\scriptsize{\myhelvetica\tiny \color{black!50} Last update: 6.12.2023}}
\fancyfoot[R]{\scriptsize{\raggedleft\myhelvetica\tiny \color{black!50} Seite 1/2}}
...
\fancyhead{}
\fancyfoot{}
% \fancyhead[R]{\raggedleft\includegraphics[scale=1]{Logo_correct.pdf}}
\fancyfoot[R]{\scriptsize{\myhelvetica\tiny \color{black!50} Seite 2/2}}
\renewcommand{\headrulewidth}{0pt}
